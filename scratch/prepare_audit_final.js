...
for (let i = 0; i < 10; i++) {
  ...
  fs.writeFileSync(`scratch/name_audit_final_batch_${i + 1}.json`, JSON.stringify(batch, null, 2), 'utf8');
}

console.log(`Created 10 final batches of size ~${batchSize} in scratch/name_audit_final_batch_X.json`);
