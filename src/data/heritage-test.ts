...
export const archetypes: Record<string, { name: { ko: string; en: string; de: string; ja: string; es?: string; fr?: string }; description: { ko: string; en: string; de: string; ja: string; es?: string; fr?: string } }> = {
  'LRDI': {
    name: {ko: "대륙을 재설계하는 설계자", en: "The Universal Architect", de: "Der universelle Architekt", ja: "世界を再設計する設計者" , es: "El Arquitecto Universal", fr: "L'Architecte Universel"},
  ...
  'LPDI': {
    name: {ko: "멈추지 않는 시대의 개척자", en: "The Eternal Pioneer", de: "Der ewige Pionier", ja: "立ち止まらない時代の開拓者" , es: "El Pionero Eterno", fr: "Le Pionnier Audacieux"},
  ...
  'LRHI': {
    name: {ko: "깨어있는 지혜의 개혁가", en: "The Enlightened Reformer", de: "Der aufgeklärte Reformer", ja: "目覚めた知恵の改革者" , es: "El Reformador Iluminado", fr: "Le Réformateur Éclairé"},
  ...
  'LPHI': {
    name: {ko: "영감을 불어넣는 시대의 리더", en: "The Inspirational Leader", de: "Der inspirierende Anführer", ja: "インスピレーションを与える時代のリーダー" , es: "El Líder Inspirador", fr: "Le Leader Inspirateur"},
  ...
  'LRDT': {
    name: {ko: "질서를 수호하는 결단가", en: "The Traditional Decider", de: "Der traditionelle Entscheider", ja: "秩序を守護する決断家" , es: "El Decisor Tradicional", fr: "Le Décideur Traditionnel"},
  ...
  'LPDT': {
    name: {ko: "신념을 지키는 강철의 혁명가", en: "The Charismatic Rebel", de: "Der charismatische Rebell", ja: "信念を貫く鋼の革命家" , es: "El Rebelde Carismático", fr: "Le Rebelle Charismatique"},
  ...
  'LRHT': {
    name: {ko: "품격 있는 시대의 중재자", en: "The Gracious Sovereign", de: "Der gnädige Souverän", ja: "品格ある時代の調停者" , es: "El Soberano Benevolente", fr: "Le Souverain Bienveillant"},
  ...
  'LPHT': {
    name: {ko: "모두를 품는 역사의 수호자", en: "The Devoted Unifier", de: "Der hingebungsvolle Vereiner", ja: "すべてを包み込む歴史の守護者" , es: "El Unificador Dedicado", fr: "L'Unificateur Dévoué"},
  ...
  'SRDI': {
    name: {ko: "정교한 미래의 발명가", en: "The Precise Inventor", de: "Der präzise Erfinder", ja: "精巧な未来の発明家" , es: "El Inventor Preciso", fr: "L'Inventeur Précis"},
  ...
  'SPDI': {
    name: {ko: "불꽃 같은 영혼의 예술가", en: "The Radical Creator", de: "Der radikale Schöpfer", ja: "炎のような魂の芸術家" , es: "El Creador Radical", fr: "Le Créateur Radical"},
  ...
  'SRHI': {
    name: {ko: "실천하는 지혜의 현자", en: "The Practical Sage", de: "Der praktische Weise", ja: "実践する知恵の賢者" , es: "El Sabio Práctico", fr: "Le Sage Visionnaire"},
  ...
  'SPHI': {
    name: {ko: "아름다움을 빚는 조화의 거장", en: "The Compassionate Artist", de: "Der mitfühlende Künstler", ja: "美を紡ぐ調和の巨匠" , es: "El Artista Compasivo", fr: "L'Artiste Compatissant"},
  ...
  'SRDT': {
    name: {ko: "냉철한 일상의 수호자", en: "The Stoic Guardian", de: "Der stoische Wächter", ja: "冷静沈着な日常の守護者" , es: "El Guardián Estoico", fr: "Le Gardien Stoïque"},
  ...
  'SPDT': {
    name: {ko: "행동하는 양심의 투사", en: "The Passionate Activist", de: "Der leidenschaftliche Aktivist", ja: "行動する良心の闘士" , es: "El Activista Apasionado", fr: "L'Activiste Passionné"},
  ...
  'SRHT': {
    name: {ko: "겸손한 삶의 관찰자", en: "The Humble Protector", de: "Der bescheidene Beschützer", ja: "謙虚な生活の観察者" , es: "El Protector Humilde", fr: "Le Protecteur Humble"},
  ...
  'SPHT': {
    name: {ko: "평화를 사랑하는 영혼", en: "The Gentle Soul", de: "Die sanfte Seele", ja: "平和を愛する温和な魂" , es: "El Alma Gentil", fr: "L'Âme Douce"},
