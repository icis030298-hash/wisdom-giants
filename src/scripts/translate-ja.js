...
const jaUiData = {
  ...
  "Hero": {
    ...
    "guide": {
      ...
      "epic": "人生の物語",
      "epicDesc": "偉人たちが自ら語っているかのように綴られた生涯の記録を読みましょう。",
      "chat": "リアルタイムチャット",
  ...
  "GiantsGrid": {
    "title": "歴史的偉人",
    "description": "人類の歩みを変えた人物たちの知恵を探索しましょう。偉人を選択して、時間と空間を超えた対話を始めましょう。",
  ...
  "About": {
    ...
    "visionDesc": "「私がより遠くを見ることができたとすれば、それは巨人の肩の上に立ったからです。」 - アイザック・ニュートン。私たちは、現代の複雑な問題への答えが、歴史上の偉大な先人たちの人生にすでに織り込まれているのではないかという信念からスタートしました。",
  ...
  "Terms": {
    ...
    "eligibilityDesc": "当サービスは、13歳以上のユーザーを対象としています。13歳未満のユーザーが利用する場合は、グローバルな児童プライバシー法に基づき、親権者の同意を得ているものとみなします。当プラットフォームは、未成年の無断アクセスに起因する一切の責任を負いません。",
