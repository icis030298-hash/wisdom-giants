        ...
        <div className="space-y-8" style={{ color: "var(--rd-text-body)" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-start pt-4" style={{ gap: "var(--rd-grid-gutter)" }}>
            ...
            <div className="p-5 space-y-3" style={{ background: "var(--rd-surface)", border: "1px solid var(--rd-border)", borderRadius: "var(--rd-card-radius)" }}>
              ...
              <h3 className="font-serif" style={{ color: "var(--rd-text-ink)", fontSize: "var(--rd-card-name-size)", fontWeight: "var(--rd-card-name-weight)", letterSpacing: "var(--rd-card-name-tracking)" }}>1. 프로젝트의 탄생 배경과 인문학적 사명</h3>
              <p className="break-keep" style={{ color: "var(--rd-text-body)", fontSize: "var(--rd-card-intro-size)", lineHeight: "var(--rd-card-intro-leading)" }}>
            ...
            <div className="p-5 space-y-3" style={{ background: "var(--rd-surface)", border: "1px solid var(--rd-border)", borderRadius: "var(--rd-card-radius)" }}>
              ...
              <h3 className="font-serif" style={{ color: "var(--rd-text-ink)", fontSize: "var(--rd-card-name-size)", fontWeight: "var(--rd-card-name-weight)", letterSpacing: "var(--rd-card-name-tracking)" }}>2. AI 멀티에이전트 및 대화형 협업 엔진</h3>
              <p className="break-keep" style={{ color: "var(--rd-text-body)", fontSize: "var(--rd-card-intro-size)", lineHeight: "var(--rd-card-intro-leading)" }}>
            ...
            <div className="p-5 space-y-3" style={{ background: "var(--rd-surface)", border: "1px solid var(--rd-border)", borderRadius: "var(--rd-card-radius)" }}>
              ...
              <h3 className="font-serif" style={{ color: "var(--rd-text-ink)", fontSize: "var(--rd-card-name-size)", fontWeight: "var(--rd-card-name-weight)", letterSpacing: "var(--rd-card-name-tracking)" }}>3. 엄격한 역사 복원과 다국어 지원 체계</h3>
              <p className="break-keep" style={{ color: "var(--rd-text-body)", fontSize: "var(--rd-card-intro-size)", lineHeight: "var(--rd-card-intro-leading)" }}>
            ...
            <div className="p-5 space-y-3" style={{ background: "var(--rd-surface)", border: "1px solid var(--rd-border)", borderRadius: "var(--rd-card-radius)" }}>
              ...
              <h3 className="font-serif" style={{ color: "var(--rd-text-ink)", fontSize: "var(--rd-card-name-size)", fontWeight: "var(--rd-card-name-weight)", letterSpacing: "var(--rd-card-name-tracking)" }}>4. 구글 게시자 정책 및 건전한 생태계 준수</h3>
              <p className="break-keep" style={{ color: "var(--rd-text-body)", fontSize: "var(--rd-card-intro-size)", lineHeight: "var(--rd-card-intro-leading)" }}>
        ...
        <div className="space-y-8" style={{ color: "var(--rd-text-body)" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-start pt-4" style={{ gap: "var(--rd-grid-gutter)" }}>
            ...
            <div className="p-5 space-y-3" style={{ background: "var(--rd-surface)", border: "1px solid var(--rd-border)", borderRadius: "var(--rd-card-radius)" }}>
              ...
              <h3 className="font-serif" style={{ color: "var(--rd-text-ink)", fontSize: "var(--rd-card-name-size)", fontWeight: "var(--rd-card-name-weight)", letterSpacing: "var(--rd-card-name-tracking)" }}>1. Contextual Heritage and Humanistic Mission</h3>
              <p className="break-keep" style={{ color: "var(--rd-text-body)", fontSize: "var(--rd-card-intro-size)", lineHeight: "var(--rd-card-intro-leading)" }}>
            ...
            <div className="p-5 space-y-3" style={{ background: "var(--rd-surface)", border: "1px solid var(--rd-border)", borderRadius: "var(--rd-card-radius)" }}>
              ...
              <h3 className="font-serif" style={{ color: "var(--rd-text-ink)", fontSize: "var(--rd-card-name-size)", fontWeight: "var(--rd-card-name-weight)", letterSpacing: "var(--rd-card-name-tracking)" }}>2. AI Multi-Agent Orchestration & Caching Engine</h3>
              <p className="break-keep" style={{ color: "var(--rd-text-body)", fontSize: "var(--rd-card-intro-size)", lineHeight: "var(--rd-card-intro-leading)" }}>
            ...
            <div className="p-5 space-y-3" style={{ background: "var(--rd-surface)", border: "1px solid var(--rd-border)", borderRadius: "var(--rd-card-radius)" }}>
              ...
              <h3 className="font-serif" style={{ color: "var(--rd-text-ink)", fontSize: "var(--rd-card-name-size)", fontWeight: "var(--rd-card-name-weight)", letterSpacing: "var(--rd-card-name-tracking)" }}>3. Rigorous Curation & Global Language Accessibility</h3>
              <p className="break-keep" style={{ color: "var(--rd-text-body)", fontSize: "var(--rd-card-intro-size)", lineHeight: "var(--rd-card-intro-leading)" }}>
            ...
            <div className="p-5 space-y-3" style={{ background: "var(--rd-surface)", border: "1px solid var(--rd-border)", borderRadius: "var(--rd-card-radius)" }}>
              ...
              <h3 className="font-serif" style={{ color: "var(--rd-text-ink)", fontSize: "var(--rd-card-name-size)", fontWeight: "var(--rd-card-name-weight)", letterSpacing: "var(--rd-card-name-tracking)" }}>4. Adherence to Google Publisher Policies</h3>
              <p className="break-keep" style={{ color: "var(--rd-text-body)", fontSize: "var(--rd-card-intro-size)", lineHeight: "var(--rd-card-intro-leading)" }}>
